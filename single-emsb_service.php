          ...
          <div class="em-booking-form-container">
            <form method="post" class="needs-validation" novalidate <?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?> >
              <div class="em-booking-form-fields">
                ...
                <div class="form-row">
                  <div class="col-md-12 mb-3">
                    <input name="emsb_user_telephone" id="emsb_user_telephone" type="tel" maxlength="25" size="40" class="form-control"  placeholder="<?php _e( '8801812345678 ', 'emsb-service-booking' ); ?>" required>
                    <div class="invalid-feedback">
